            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='form-container'>
                    <div>
                        ...
                        <input type='text' name='firstName' id='1' value={firstName} onChange={fChangeHandler} /> </div>
                    {/* <input type='text' name='firstName' value={datas.firstName}  onChange={e=>setdatas([{...datas,firstName:e.target.value}])}   ></input></div> */}


                    <div>
                        <label>Enter your LastName</label>
                        <input type='text' name='lastName' id='2' value={lastName} onChange={lChangeHandler}  ></input></div>
                    ...
                    <div>
                        ...
                        <input type='email' name='email' id='3' value={email} onChange={emailHandler} ></input></div>
                    <div>
